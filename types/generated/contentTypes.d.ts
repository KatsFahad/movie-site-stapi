...
export interface ApiFightsceneFightscene extends Schema.CollectionType {
  ...
  info: {
    singularName: 'fightscene';
    pluralName: 'fightscenes';
    displayName: 'fightscene';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiTop5Top5 extends Schema.CollectionType {
  ...
  attributes: {
    ...
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::top5.top5', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    updatedBy: Attribute.Relation<'api::top5.top5', 'oneToOne', 'admin::user'> &
      Attribute.Private;
  };
}
